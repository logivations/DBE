...
class InputParameterModel extends AbstractColumnModel {
	...
	public static createInputParametersModels(inputParameterModels: InputParameterModel[], getMetadata) {
	...
	public setDefaultValidationRules() {
		...
		this.rules.push(getAsyncRuleForInput(this.getName(), this.actionId, () => this.getMetadata().getTable().getTableName()));
	}

	public setForeignKeyData() {
		return null;
	}
