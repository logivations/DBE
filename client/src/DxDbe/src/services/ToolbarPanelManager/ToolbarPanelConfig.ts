...
class ToolbarPanelConfigBuilder {
	...
	private isReloadRowsQuantityButtonVisible = false;
	...
	public setIsReloadRowsQuantityButtonVisible(isReloadRowsQuantityButtonVisible: boolean): ToolbarPanelConfigBuilder {
		this.isReloadRowsQuantityButtonVisible = isReloadRowsQuantityButtonVisible;
		return this;
	}
	...
	public build(): ToolbarPanelConfig {
		return new ToolbarPanelConfig(
			...
			this.isReloadRowsQuantityButtonVisible,
...
export class ToolbarPanelConfig {
	constructor(
		...
		public isReloadRowsQuantityButtonVisible: boolean,
