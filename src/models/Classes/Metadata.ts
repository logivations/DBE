...
class Metadata implements IMetadata {
	...
	private setReportInputParameters(reportInputParameters: InputParameterModel[] | undefined): Metadata {
		this.reportInputParameters = InputParameterModel.createInputParametersModels(reportInputParameters, () =>
			this.getMetadata(),
		);
		return this;
	}
	...
	private setTableRelatedUserParameters(
		...
		this.tableRelatedUserParameters = TableRelatedUserParameters.create(
			tableRelatedUserParameters,
	...
	private setWarehouseIdHolder(warehouseIdHolder: WarehouseIdHolder | undefined): Metadata {
		this.warehouseIdHolder = new WarehouseIdHolder(warehouseIdHolder.warehouseId);
		return this;
	}
